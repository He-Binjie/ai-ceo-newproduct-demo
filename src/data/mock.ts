...
export const mockBOMRecords: BOMRecord[] = [
  ...
  },
  {
    ...
    launchDate: '2026-09-15',
    materialName: '老盐糖浆',
    materialCode: '20260905-005',
    spec: '500g/瓶×20瓶/箱',
    unit: '瓶',
    unitUsage: 194,
    usageUnit: 'g',
    shelfLifeDays: 30,
    stockCoefficient: 1.2,
    cupRatioW1: 0.05,
    cupRatioW2: 0.035,
    cupRatioW3: 0.022,
    cupRatioW4: 0.013,
  ...
  },
  {
    ...
    launchDate: '2026-09-15',
    materialName: '冷冻凤梨汁',
    materialCode: '20260906-006',
    spec: '1kg/瓶×12瓶/箱',
    unit: '瓶',
    unitUsage: 23.04,
    usageUnit: 'g',
    shelfLifeDays: 9,
    stockCoefficient: 1.3,
    cupRatioW1: 0.05,
    cupRatioW2: 0.035,
    cupRatioW3: 0.022,
    cupRatioW4: 0.013,
